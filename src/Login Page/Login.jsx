...
const errorMessage = () => {
  ...
  return (
    <div><center>
          <div class="card bg-warning mb-3" style={{maxwidth:"18rem"}}>
          <div class="card-body" >
              <h1 class="card-title" style={{backgroundColor:'grey'}}>LOGIN PAGE</h1><br/><br/>
                      ...
                      <input onChange={handleLoginPwd} className="input"
                          ...
                          <br />
                          <br />
                      <button onClick={handleLogin} className="btn" value={Login} style={{background:'grey',color:'white'}}>Login</button>
